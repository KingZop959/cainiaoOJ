...
@Slf4j
@Component
public class CDockerSandBox extends CodeSandboxTemplate {
    ...
    public CDockerSandBox(DockerContainerPool dockerContainerPool, DockerClient dockerClient){
    ...
    public ExecuteCodeResponse executeCode(ExecuteCodeRequest executeCodeRequest) {
        ...
        File userCodeFile = saveCodeToFile(code,GLOBAL_CODE_PATH_NAME,GLOBAL_C_NAME);
        try {
